...
const CompanyLayout: React.FC = () => {
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        <Header style={{ padding: '0 24px', background: 'var(--color-bg-primary)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid var(--color-border)', position: 'sticky', top: 0, zIndex: 100 }}>
          <Button
            type="text"
